            ...
            <g:if test="${editError}">
                <g:javascript>
                    if(window.self!=window.parent){
                         window.parent.postMessage("rundeck:node:edit:error:${editError.encodeAsJavaScript()}","http://localhost:9090");
                         }
                </g:javascript>
            </g:if>
            <g:else>
                <g:javascript>
                if(window.self!=window.parent){
                         window.parent.postMessage("rundeck:node:edit:started","http://localhost:9090");
                    }
                </g:javascript>            
            </g:else>
            <g:form method="post" >
                ...
                <div class="buttons">
                    ...
                    <span class="button"><g:actionSubmit class="cancel" action="show" value="${message(code: 'default.button.cancel.label', default: 'Cancel')}" /></span>
                </div>
            </g:form>
        </div>
    </body>
